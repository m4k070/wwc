...
- [ ] sm83_full (10,767 gates) の配線完走 — 2026-09-18 の試行:
      * 16x12: NetId 5816 で輻輳失敗 (72 分)
      * 20x14: 14,600/18,037 端子で輻輳失敗 (90 分)
      * 24x16: **15,153/18,037 端子 (84%) で輻輳失敗 (93.6 分)**。NetId 165/1630/2885/4040/4341 が
        それぞれ 30 本撤去しても通らず、最後は探索範囲 32 倍でも経路なし
      次の案: (A) ピッチ 28x20 を pitchSequence に追加、(B) rip-up の撤去数・再試行回数を増やす、
      (C) 配置を接続性ベースにする (今は宣言順の格子配置)
- [ ] CB 命令の動作検証
